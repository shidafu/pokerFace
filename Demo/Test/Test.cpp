...
int main(int argc, char* argv[])
{
	...
	for (int i = 0; i < files1.size(); i++)
	{
		...
		face_marks1.push_back(*(new tools::faceLandMark()));		
	...
	for (int i = 0; i < files2.size(); i++)
	{
		...
		face_marks2.push_back(*(new tools::faceLandMark()));
	...
	for (int i = 0; i < files1.size(); i++)
	{
		...
		face_num1[i] = face_detector.detect(filename1,
			face_infos1.at(i), face_marks1.at(i));
		...
		//if (face_num1[i] > 0)
		{
			...
			std::cout << "   \"marks\":[["
				<< face_marks1.at(i).mark[0].x << "," << face_marks1.at(i).mark[0].y << "],"
				<< "[" << face_marks1.at(i).mark[1].x << "," << face_marks1.at(i).mark[1].y << "],"
				<< "[" << face_marks1.at(i).mark[2].x << "," << face_marks1.at(i).mark[2].y << "],"
				<< "[" << face_marks1.at(i).mark[3].x << "," << face_marks1.at(i).mark[3].y << "],"
				<< "[" << face_marks1.at(i).mark[4].x << "," << face_marks1.at(i).mark[4].y << "]],\n";
			fout << "   \"marks\":[["
				<< face_marks1.at(i).mark[0].x << "," << face_marks1.at(i).mark[0].y << "],"
				<< "[" << face_marks1.at(i).mark[1].x << "," << face_marks1.at(i).mark[1].y << "],"
				<< "[" << face_marks1.at(i).mark[2].x << "," << face_marks1.at(i).mark[2].y << "],"
			...
			if (showImg)
			{
				...
				for (int k = 0; k < 5; k++)
				{
					cv::circle(sImg, cv::Point(face_marks1.at(i).mark[k].x, face_marks1.at(i).mark[k].y), 4,
						CV_RGB(0, 255, 255), 1);
				}
			...
			face_detector.corp(img, face_marks1.at(i), corp_img);
	...
	for (int i = 0; i < files2.size(); i++)
	{
		...
		face_num2[i] = face_detector.detect(filename2,
			face_infos2.at(i), face_marks2.at(i));
		...
		//if (face_num2[i] > 0)
		{
			...
			std::cout << "   \"marks\":[["
				<< face_marks2.at(i).mark[0].x << "," << face_marks2.at(i).mark[0].y << "],"
				<< "[" << face_marks2.at(i).mark[1].x << "," << face_marks2.at(i).mark[1].y << "],"
				<< "[" << face_marks2.at(i).mark[2].x << "," << face_marks2.at(i).mark[2].y << "],"
				<< "[" << face_marks2.at(i).mark[3].x << "," << face_marks2.at(i).mark[3].y << "],"
				<< "[" << face_marks2.at(i).mark[4].x << "," << face_marks2.at(i).mark[4].y << "]],\n";
			fout << "   \"marks\":[["
				<< face_marks2.at(i).mark[0].x << "," << face_marks2.at(i).mark[0].y << "],"
				<< "[" << face_marks2.at(i).mark[1].x << "," << face_marks2.at(i).mark[1].y << "],"
				<< "[" << face_marks2.at(i).mark[2].x << "," << face_marks2.at(i).mark[2].y << "],"
			...
			if (showImg)
			{
				...
				for (int k = 0; k < 5; k++)
				{
					cv::circle(sImg, cv::Point(face_marks2.at(i).mark[k].x, face_marks2.at(i).mark[k].y), 4,
						CV_RGB(0, 255, 255), 1);
				}
				cv::imshow("source image", sImg);
				cv::waitKey(1);
			...
			// Corp
			cv::Mat corp_img = cv::Mat(face_rows, face_cols, CV_8UC(face_chn));
			face_detector.corp(img, face_marks2.at(i), corp_img);
